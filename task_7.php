<?php
    ...
    $prepare = $pdo->prepare('SELECT * FROM `staff` ');
    $prepare->execute();
                        ...
                        <div class="d-flex flex-wrap demo demo-h-spacing mt-3 mb-3">
                            ...
                            <?php foreach ($result as $key => $value) : ?>
                                <div class="<?= $value['banned'] ? 'banned' : '';  ?> rounded-pill bg-white shadow-sm p-2 border-faded mr-3 d-flex flex-row align-items-center justify-content-center flex-shrink-0">
                                    ...
                                    <div class="ml-2 mr-3">
                                        <h5 class="m-0"><?= $value['name'] ?><small class="m-0 fw-300"><?= $value['position'] ?></small></h5>
                                        <a href="https://twitter.com/@myplaneticket" class="text-info fs-sm" target="_blank"><?= $value['twitter'] ?></a> -
